...
function clearcookie() {
	document.cookie = "qy_username=; path=/;domain=xianyu.com;expires=" + new Date(1970, 1, 1).toGMTString(), document.cookie = "qy_userpwd=; path=/;domain=xianyu.com;expires=" + new Date(1970, 1, 1).toGMTString(), document.cookie = "qy_userid=; path=/;domain=xianyu.com;expires=" + new Date(1970, 1, 1).toGMTString()
}
function userreg() {
...
pp = null, $.extend({
	...
	a = a || {}, $.extend(b, a), null != a.msg && void 0 != a.msg && $("#ui-cnt").html(a.msg), 1 == parseInt(a.rcode) || 1 == parseInt(a.code) ? $("#ui-cnt").removeClass("loading error alert").addClass("succ") : parseInt(a.rcode) < 1 || parseInt(a.code) < 1 && $("#ui-cnt").removeClass("loading alert succ").addClass("error"), pp = setTimeout("$.closefloatdiv()", b.intvaltime)
}, function(a) {
