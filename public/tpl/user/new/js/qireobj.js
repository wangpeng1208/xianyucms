...
function clearcookie() {
    document.cookie = "qy_username=; path=/;domain=xianyu.com;expires=" + (new Date(1970, 1, 1)).toGMTString();
    document.cookie = "qy_userpwd=; path=/;domain=xianyu.com;expires=" + (new Date(1970, 1, 1)).toGMTString();
	document.cookie = "qy_userid=; path=/;domain=xianyu.com;expires=" + (new Date(1970, 1, 1)).toGMTString();
}