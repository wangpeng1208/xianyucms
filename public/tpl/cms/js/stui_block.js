...
var stui = {
	...
	'mobile': {
		...
		'slide': function() {
			$.getScript("https://i.zhuzhuhao.com/Statics/js/flickity.pkgd.min.js", function() {
	...
	'images': {
		'lazyload': function() {
			$.getScript("https://i.zhuzhuhao.com/Statics/js/jquery.lazyload.min.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 500,
					failurelimit: 15,
	...
	'common': {
		...
		'headroom': function() {
			$.getScript("https://i.zhuzhuhao.com/Statics/js/headroom.min.js", function() {
				$("#header-top", function() {
