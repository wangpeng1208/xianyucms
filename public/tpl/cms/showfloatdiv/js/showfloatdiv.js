...
jQuery.showfloatdiv = function(ox) {
	...
	$("#xianyubox_overlay").remove();
	$("#xianyubox").remove();
	if (oxdefaults.wantclose == 1) {
		var floatdiv = $('<div class="xianyubox-overlayBG" id="xianyubox_overlay"></div><div id="xianyubox" class="xianyubox png-img"><iframe frameborder="0" class="ui-iframe"></iframe><table class="ui-dialog-box"><tr><td><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-tip alert" id="ui-cnt"><span id="xtip">'
				+ oxdefaults.txt
				+ '</span></div></div><div class="ui-dialog-close"><span class="close">关闭</span></div></div></td></tr></table></div>');
		$("body").append(floatdiv);
		$("#xianyubox_overlay").fadeIn(500);
		$("#xianyubox").fadeIn(500);
		...
		var floatdiv = $('<div class="xianyubox_overlayBG" id="xianyubox_overlay"></div><div id="xianyubox" class="xianyubox"><iframe frameborder="0" class="ui-iframe"></iframe><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-box"<div class="ui-cnt" id="ui-cnt">'
				+ oxdefaults.txt + '</div></div></div></div></div>');
		$("body").append(floatdiv);
		$("#xianyubox_overlay").fadeIn(500);
		$("#xianyubox").fadeIn(500);
	}
	$('#xianyubox_overlay').bind('click', function(e) {
		$.closefloatdiv(e);
		if (pp != null) {
			clearTimeout(pp);
		}
