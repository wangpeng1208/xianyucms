...
document.write('<iframe class="xianyucms-play-iframe" src="'+xianyucms_player.url+'" width="100%" height="100%" frameborder="0" scrolling="no" allowfullscreen="true"></iframe>');
ads_show(); 
function ads_show(){
	try{
